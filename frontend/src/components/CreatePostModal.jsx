    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            for (const f of files) {
                ...
                const uploadRes = await fetch(`/api/media/upload/${postId}`, {
                    method: 'POST',
                    headers: {
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between px-5 py-4" style={{ borderTop: isDark ? '1px solid rgba(255,255,255,0.06)' : '1px solid rgba(0,0,0,0.06)' }}>
                            ...
                            <button onClick={handleSubmit} disabled={!content.trim() || loading}
                                className="px-6 py-2.5 rounded-xl text-white transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                                style={{
