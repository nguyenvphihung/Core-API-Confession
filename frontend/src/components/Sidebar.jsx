...
import { Home, User, Sun, Moon, PenSquare, LogOut, MessageSquareHeart } from 'lucide-react';
            ...
            >
                <div>
                    ...
                    <button
                        ...
                        className="mt-5 w-full py-3 rounded-xl flex items-center justify-center gap-2 text-white transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] cursor-pointer"
                        style={{
