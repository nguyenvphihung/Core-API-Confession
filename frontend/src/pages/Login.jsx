        ...
        >
            ...
            >
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    {error && (
                        <div className="px-4 py-3 rounded-xl text-sm" style={{ background: 'rgba(255, 107, 107, 0.1)', color: '#FF6B6B' }}>
                            {error}
                        </div>
                    )}
                    ...
                    <motion.button
                        ...
                        disabled={loading}
                        whileTap={{ scale: 0.98 }}
                        className="w-full py-3 rounded-xl text-white mt-2 transition-all duration-200 cursor-pointer disabled:opacity-50"
                        style={{
